...
export const NavBar = () => {
  ...
  return (
    <div className="navBackground shadow-sm responsive-container">
          ...
          <div className="container-fluid ml-3">
            ...
            <div className="collapse navbar-collapse" id="navbarNavDropdown">
              <ul className="navbar-nav ms-auto">
                <li className={`nav-item ml-3 ${activeLink === "/" ? "active" : ""}`} onClick={() => setActiveLink("/")}>
                  <Link className="nav-link ml-3" aria-current="page" to="/">
                    🏠 <span className="sprt">Support Center</span> Home
                  </Link>
                </li>
                <li
                  className={`nav-item ml-3 ${activeLink === "/knowledgebase" ? "active" : ""}`}
                ...
                <li
                  className={`nav-item ml-3 ${activeLink === "/opennewticket" ? "active" : ""}`}
                  onClick={() => setActiveLink("/opennewticket")}
                >
                  <Link className="nav-link" to="/opennewticket">
                    <i className="fa-sharp fa-solid fa-file-circle-plus"></i> Open New Ticket
                  </Link>
                </li>
                <li
                  className={`nav-item ml-3 ${activeLink === "/checkticketstatus" ? "active" : ""}`}
                  onClick={() => setActiveLink("/checkticketstatus")}
                >
                  <Link className="nav-link" to="/checkticketstatus">
                    <i className="fa-sharp fa-solid fa-file-arrow-up"></i> Check Ticket Status
                  </Link>
                </li>
